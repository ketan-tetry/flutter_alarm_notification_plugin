 ...
 */
public class FlutterNotificationPlugin implements FlutterPlugin, MethodCallHandler {
    public final static String START_FOREGROUND_ACTION = "com.valueappz.flutter_notification_plugin.action.startforeground";
    public final static String STOP_FOREGROUND_ACTION = "com.valueappz.flutter_notification_plugin.action.stopforeground";

    private static FlutterNotificationPlugin instance;
    ...
    public static void registerWith(Registrar registrar) {
        if (instance == null) {
            instance = new FlutterNotificationPlugin();
        }
    ...
    public void onAttachedToEngine(Context applicationContext, BinaryMessenger messenger) {
        ...
        final MethodChannel channel = new MethodChannel(this.messenger, "com.valueappz.flutter_notification_plugin/main");
        channel.setMethodCallHandler(this);
        callbackChannel = new MethodChannel(messenger, "com.valueappz.flutter_notification_plugin/callback");
    }
    ...
    public void onMethodCall(MethodCall call, Result result) {
        switch (call.method) {
            case "startForegroundService":
                ...
                final String sound = call.argument("sound");

                launchForegroundService(icon, color, title, content, subtext, chronometer, stopAction, stopIcon, stopText,sound);
