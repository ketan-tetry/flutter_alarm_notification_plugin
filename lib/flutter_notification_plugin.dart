...
class FlutterNotificationPlugin {
  static const MethodChannel _mainChannel =
      const MethodChannel('com.valueappz.flutter_notification_plugin/main');

  static const MethodChannel _callbackChannel =
      const MethodChannel('com.valueappz.flutter_notification_plugin/callback');
